...
function AddShop() {
  ...
  return (
    <div className=" mx-10/12 w-full h-screen  overflow-hidden ">
      <h1 className="text-2xl fixed z-10 ml-12 font-semibold ">Add New Shop</h1>
      <div className="h-[84vh] flex flex-col gap-2  overflow-y-scroll mb-5 m-2 mt-12 md:mt-14 md:m-8 scroll-hidden no-scrollbar ">
        <div className="border border-slate-400 rounded-lg  p-5">
          <h2 className="text-xl font-medium">Shop Images</h2>
        ...
        <div className=" flex flex-col border border-slate-400 rounded-lg  p-5">
          ...
          <div className="flex mt-5 flex-col gap-2">
            <h2 className="font-sm font-normal">Shop Name</h2>
            <input
              type="text"
          ...
          <div className="flex mt-5 flex-col gap-2">
            <h2 className="font-sm font-normal">Shop Type</h2>
            <input
              type="text"
          ...
          <div className="flex mt-5 flex-col gap-2">
            <h2 className="font-sm font-normal">Shop Description</h2>
            <textarea
              type="text"
